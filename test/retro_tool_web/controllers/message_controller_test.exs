defmodule RetroToolWeb.MessageControllerTest do
  use RetroToolWeb.ConnCase

  alias RetroTool.Retrospective

  @create_attrs %{content: "some content", message_type: "some message_type"}
  ...
  def fixture(:message) do
    {:ok, message} = Retrospective.create_message(@create_attrs)
    message
  end
